    ...
    <div class="container py-3">
      <main class="row">
        <div class="col-sm-12 col-lg-6 py-3">
          <h3 class="text-white">Agendar Trabajos</h3>
            <form action="../controladores/nva_tarea.php" method="post">                
                  <input id="fecha" class="form-control my-2" type="date" name="fecha" placeholder="Fecha:">
                  <input id="tiempo" class="form-control my-2" type="number" name="tiempo"  placeholder="Tiempo Asignado en horas:">
                  <textarea id="descripcion" class="form-control my-2" name="descripcion" rows="1" placeholder="Título:"></textarea>
                  <textarea id="observaciones" class="form-control my-2" name="observaciones" rows="5" col="2" placeholder="Detalle:"></textarea>
