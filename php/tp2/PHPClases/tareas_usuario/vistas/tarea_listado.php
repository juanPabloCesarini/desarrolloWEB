...
<body class="bg-tareas">
  <span style="background:  #002e66;" class="arriba icon-arrow-up"></span>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item py-1 mr-2">
                                <a class="nav-link txt-nav btn btn-md btn-info" href="../../perfil_usuario/vistas/altaUsuarios.php">
                                  <span class="icon-group mr-2">Usuarios
                                </a>
                            </li>
                            <li class="nav-item py-1 mr-2">
    ...
    <div class="container py-3">
      <main>
      <div class="row">
        <h3 class="h3 text-white">Agenda</h3>
      </div>
      <div class="row">
        <div class="col-sm-12 col-md-4  py-3">
                <div class="card" style="width: 18rem;">
                    <img src="../../../../../img/agenda.jpg" class="card-img-top" alt="...">
                    <div class="card-body agenda-transp">
                        <h5 class="card-title">All</h5>
                        <p class="card-text">Agenda completa para tener una amplia mirada de las futuras acciones.</p>
                        <form action="../controladores/listados.php" method="post">
                        <input type="hidden" name="tipoList" value="uno">
                            <input type="submit" value="Consultar"  class="txt-nav btn btn-info">
                        </form>
                    </div>
                </div>
        </div>
        <div class="col-sm-12 col-md-4  py-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body agenda-transp">
                        ...
                        <p class="card-text">Con este listado podes ver toda la organización de un día determinado. </p>
                        <form action="../controladores/listados.php" method="post">
                            <input type="date" name="fecha" class="form-control my-2" id="" placeholder="Fecha:">
                            <input type="hidden" name="tipoList" value="dos">
                            <input type="submit" value="Consultar" class="txt-nav btn btn-info">
                        </form>
                    </div>
                </div>
         ...
         <div class="col-sm-12 col-md-4  py-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body agenda-transp">
                        ...
                        <p class="card-text">Te permite controlar de una manera fácil quién tiene la agenda más cargada y decidir hacer los cambios necesarios.</p>
                        <form action="../controladores/listados.php" method="post">
                            <div class="form-group my-2">
                                <select id="equipo" class="form-control my-2" name="equipo">
                                    <option>Responsable:</option>
                                    <?php 
                                        require_once("../../conexion.php");
                                        require_once("../../perfil_usuario/usuario.php");
                                        require_once("../../perfil_usuario/usuario_CRUD.php");
                                        $usuario= new Usuario();
                                    ...
                                    ?>
                                    <?php
                                            echo $us->getApellido(). ", ". $us->getNombre();
                                            echo "</option>";
                                    }?>
                                    <?php
                                echo '</select>'?>
                                <input type="hidden" name="tipoList" value="tres">
                                <input type="submit" class="txt-nav btn btn-info " value="Consultar" name="guardar" id="guardar">
                            </div>
                        </form>
                    </div>
                </div>
