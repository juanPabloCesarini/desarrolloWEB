<?php
    ...
    if ($_GET['id']) {
        ...
        $consulta = $crudTarea->buscar($_GET['id']);
    }
?>
    ...
    <div class="container py-3">
      <main class="row">
        <div class="col-sm-12 col-lg-6 py-3">
          <h3 class="text-white">Reformulación de Actividad</h3>
            <form action="../controladores/modificar.php" method="post">      
                  <input type="hidden" name="idTareas" value="<?php echo $consulta->getIdTareas();?>">    
                  <input id="fecha" class="form-control my-2" type="date" name="fecha" value="<?php echo $consulta->getFecha();?>">
                  <input id="tiempo" class="form-control my-2" type="number" name="tiempo"  value="<?php echo $consulta->getTiempo();?>">
                  <textarea type="text" id="descripcion" class="form-control my-2" name="descripcion" rows="1"><?php echo $consulta->getDescripcion();?></textarea>
                  <textarea type="text" id="observaciones" class="form-control my-2" name="observaciones" rows="5" col="2" ><?php echo $consulta->getObservaciones();?></textarea>
                  <div class="form-group my-2">
                    ...
                    <input type="submit" class="txt-nav btn btn-md btn-info mt-3" value="Guardar" name="guardar" id="guardar">
                  </div>
            </form>
        </div>';?>
        <div class="col-sm-12 col-lg-6 py-3 agenda">
