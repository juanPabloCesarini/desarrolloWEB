...
if ($_GET['id']) {
    ...
    $consulta = $crud->buscarID($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="bg-tareas-equipo">
    <span class="arriba icon-arrow-up"></span>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-transparent ml-auto">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item py-1 mr-2">
                                <a class="nav-link btn btn-lg btn-outline-light" href="../../tareas_usuario/vistas/tarea.php">
        ...
        <main>
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 py-2 my-2 text-center editar">
                    ...
                    <div><a href="../vistas/modiUsuarios.php#edit" class="btn btn-outline-light">IR</a></div>
                </div>
                ...
                <div class="col-sm-12 col-md-3 py-2 my-2 text-center borrar">
                    ...
                    <div><a href="#del" class="btn btn-outline-light">IR</a></div>
                </div>
            </div>
            <div class="row" id="edit">
                <div class="col-sm-12 py-2 ">
                    <div class="container">
                        ...
                        <form action="../controladores/edit_usuario_tabla.php" method="POST">
                            <input type="hidden" class="form-control" name="id" value="<?php echo $consulta->getId();?>">
                            <div class="form-group row">
                                <span class="icon-file-numbers iconos"></span>
                                <div class="col-sm-12 col-md-5">
                                    <input type="text" class="form-control" name="codigo" value="<?php echo $consulta->getCodigo();?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <span class="icon-user iconos"></span>
                                <div class="col-sm-12 col-md-5">
                                    <input type="text" class="form-control" name="nombre" value="<?php echo $consulta->getNombre();?>">
                                </div>
                                <span class="icon-user iconos"></span>
                                <div class="col-sm-12 col-md-5">
                                    <input type="text" class="form-control" name="apellido" value="<?php echo $consulta->getApellido();?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <span class="icon-mail iconos"></span>
                                <div class="col-sm-12 col-md-5">
                                    <input type="mail" class="form-control" name="mail" value="<?php echo $consulta->getMail();?>">
                                </div>
                                <span class="icon-phone iconos"></span>
                                <div class="col-sm-12 col-md-5">
                                    <input type="text" class="form-control" name="telefono" value="<?php echo $consulta->getTelefono();?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12 col-md-5">
                                   <input type='hidden' name='editarL' value='editar'>
                                    <input type="submit" class="btn btn-lg btn-outline-light"value="Guardar">
                                </div>
                            </div>
                        </form>
                    </div>
