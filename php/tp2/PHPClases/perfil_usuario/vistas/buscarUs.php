<?php
    require_once("../controladores/buscar_un_usuario.php")
?>
        ...
        <main>
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 py-2 my-2 text-center listar">
                    ...
                    <div><a href="#nvo" class="btn btn-outline-light">IR</a></div>
                </div>
            ...
            <div class="row" id="edit">
                <div class="col-sm-12 py-2 ">
                    <div class="container">
                        ...
                        <form action="../controladores/edit_usuario.php" method="POST">
