            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 py-2 my-2 text-center borrar">
                    ...
                    <p>Cumpliste el contrato y no renovas o renuncias, podes darte la baja definitiva de nuestra aplicación
                        darte de alta nuevamente cuando gustes, buscate en el listado y dale click al tachito
                    </p>
                    <div><a href="../vistas/listado.php#list" class="btn btn-outline-light">IR</a></div>
                </div>
            </div>
            <div class="row" id="nvo">
                <div class="col-sm-12 py-2 ">
                    <div class="container">
                        <div class="nuevo">
                            <h2 class="text-center text-uppercase">Ingresar Usuario</h2>
                        </div>
                        <form action="../controladores/nvo_usuario.php" method="POST">
