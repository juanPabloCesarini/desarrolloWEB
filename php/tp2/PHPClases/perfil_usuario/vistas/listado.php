<?php
  require_once('../controladores/buscar_todos.php');
?>
...
<body class="bg-tareas-equipo">
    <span style="background:  #663800;" class="arriba icon-arrow-up"></span>
        ...
        <main>
            <div class="row">
                ...
                <div class="col-sm-12 col-md-3 py-2 my-2 text-center listar">
                    ...
                    <div><a href="listado.php#list" class="btn btn-outline-light">IR</a></div>
                </div>
            ...
            <div class="row" id="list">
                <div class="col-sm-12 py-2 ">
                    <div class="container">
                        <div class="listar">
                            <h2 class="text-center text-uppercase">Listado de Usuarios</h2>
                        </div>
                          <?php
                              include("../vistas/tablaListado.php");
                          ?>
                    </div>
                </div>
            </div>
